...
public class StagingEadbData extends AbstractTable {
  static {
    addChildClasses(0, StagingEadbData.class);

  }

  public StagingEadbData() {
    tableNameOracle = "STAGING_EADB_DATA";
    tableNamePostgres = "STAGING_EADB_DATA".toLowerCase();
