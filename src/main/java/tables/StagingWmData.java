...
public class StagingWmData extends AbstractTable {
  static {
    addChildClasses(0, StagingWmData.class);

  }

  public StagingWmData() {
    tableNameOracle = "STAGING_WM_DATA";
    tableNamePostgres = "STAGING_WM_DATA".toLowerCase();
